  ...
  <body>
	    ...
	    <div class="container">
			<a class="navbar-brand" href="{{ route('home') }}">
                <img src="{{ asset('images/logo.svg') }}" alt="" style="height: 45px;">Fin's Body Factory
            </a>
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a href="{{ route('coach') }}" class="nav-link">Coach</a></li>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/baground.jpg');" data-stellar-background-ratio="0.5">
